...
function brand_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'brand_settings[page_title_width]', array(
  		'type' => 'option',
  		'capability' => 'edit_theme_options',
  		'default' => $defaults['page_title_width'],
  		'transport' => 'postMessage',
  		'sanitize_callback' => 'brand_sanitize_width'
	) );

	$wp_customize->add_control( 'brand_settings[page_title_width]', array(
  		'type' => 'select',
  		'section' => 'brand_page_title_layout',
  		'label' => __( 'Width', 'brand' ),
			'priority' => 10,
  		'choices' => array(
			'fullwidth' => 'Full width',
    		'boxed'     => 'Boxed'
	...
	$wp_customize->add_control( 'brand_settings[header_front_page_height]', array(
  		'type' => 'text',
  		'section' => 'brand_header_general',
			'label' => __( 'Header height on front page', '' ),
...
function brand_customize_preview_css() {
	...
	<style>
		...
		#customize-control-brand_settings-post_image_no_padding .description {
			display: inline;
		}
 ...
 */
 function brand_custom_styles() {
	...
	$col_width = bcdiv( $col_width, '1', 1 );
	$tablet = apply_filters( 'brand_tablet_breakpoint', '992px' );
