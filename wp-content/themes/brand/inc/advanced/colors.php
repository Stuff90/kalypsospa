...
if( !function_exists('brand_get_default_colors' )) {
	function brand_get_default_colors() {
		$brand_default_colors = array(
			...
			'content_title_link_color'           => '',
			'content_title_link_hover_color'     => '',
			'entry_meta_text_color'              => '#999999',
...
function brand_colors_styles() {
	...
	$brand_colors = array(
		...
		'header.main-title' => array(
			'background-color' => $brand_settings['page_title_bg_color'],
		),
		...
		.separated-blocks .page-content' => array(
			'background-color' => $brand_settings['content_bg_color'],
		),

		'.one-block #primary' => array(
			'background-color' => $brand_settings['content_bg_color'],
		),
		...
		.comments-area a, .comments-area a:visited, .comments-area a:focus,
		...
		.comments-area a:hover, .comments-area a:active,
		...
		.entry-header .entry-title a:focus' => array(
			'color' => $brand_settings['content_title_link_color'],
		),

		'.entry-header .entry-title a:hover,
		.entry-header .entry-title a:active' => array(
			'color' => $brand_settings['content_title_link_hover_color'],
		),
		...
		.entry-meta a:focus' => array(
			'color' => $brand_settings['entry_meta_link_color']
		),
		...
		'body:not(.use-sections) .entry-content h1' => array(
			'color' => $brand_settings['h1_color']
		),

		'body:not(.use-sections) .entry-content h2' => array(
			'color' => $brand_settings['h2_color']
		),

		'body:not(.use-sections) .entry-content h3' => array(
			'color' => $brand_settings['h3_color']
		),

		'body:not(.use-sections) .entry-content h4' => array(
			'color' => $brand_settings['h4_color']
		),
