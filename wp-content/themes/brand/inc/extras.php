...
/**
 * Adds custom classes to the main title header.
 * @since 1.7.0
 */
add_filter( 'brand_main_title_class', 'brand_main_title_classes');
function brand_main_title_classes( $classes='' )
{
	...
	$page_title_width = $brand_settings['page_title_width'];

	if ( $page_title_width === 'boxed' ) :
		$classes[] = 'container';
	endif;
